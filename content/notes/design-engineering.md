...
- [Locale](https://joshpuckett.me/locale) - Preview local fonts, by [Josh Puckett](https://joshpuckett.me/)
- [Before and After](https://www.jm.sv/before-and-after) - Add before & after screenshots to your PR, by [James Clements](https://x.com/jamesvclements)
- [remotion.dev](https://www.remotion.dev/) - Make videos programmatically
- [Asc11.com ](https://t.co/3xZ2iVuAjS)- Make Ascii art by [Meng To ](https://x.com/MengTo)
- [agentation](https://agentation.dev/) - Annotate web elements for coding agents, by [Benji Taylor](https://benji.org/)
...
- [CMYK Emulator](https://cmyk.danielpetho.com/) - By [Daniel Petho](https://www.danielpetho.com/)
...
- [Fancy Components](https://www.fancycomponents.dev/) - Library of eye-catching [open source](https://github.com/danielpetho/fancy) components
